    ...
    public partial class AddEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedProducts", x => new { x.FavoriteProductsId, x.SavedByUsersId });
                    table.ForeignKey(
                        name: "FK_SavedProducts_Products_FavoriteProductsId",
                        column: x => x.FavoriteProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedProducts_Users_SavedByUsersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedProducts_SavedByUsersId",
                table: "SavedProducts",
